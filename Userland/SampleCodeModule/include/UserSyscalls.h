...
void call_drawRectangle(uint32_t color,uint32_t offset_x,uint32_t offset_y,uint32_t height);
void call_drawCenteredRectangle(uint32_t color,uint32_t offset_x,uint32_t offset_y,uint32_t height);
